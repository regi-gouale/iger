...
class IgerTheme {
  ...
  static OutlineInputBorder enabledBorder = OutlineInputBorder(
    ...
    borderSide: const BorderSide(color: IgerTheme.perano),
  );

  static OutlineInputBorder focusedBorder = OutlineInputBorder(
    borderRadius: BorderRadius.circular(8),
    borderSide: const BorderSide(color: IgerTheme.cornflowerBlue),
  );

  static OutlineInputBorder errorBorder = OutlineInputBorder(
    borderRadius: BorderRadius.circular(8),
    borderSide: const BorderSide(color: IgerTheme.redPastel),
  );

  static OutlineInputBorder focusedErrorBorder = OutlineInputBorder(
    borderRadius: BorderRadius.circular(8),
    borderSide: const BorderSide(color: IgerTheme.redDarkPastel),
  );
